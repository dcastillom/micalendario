...
contextBridge.exposeInMainWorld("desktopPlanner", {
  ...
  getVacations: () => ipcRenderer.invoke("planner:get-vacations"),
  saveVacation: (vacation) => ipcRenderer.invoke("planner:save-vacation", vacation),
  deleteVacation: (id) => ipcRenderer.invoke("planner:delete-vacation", id),
