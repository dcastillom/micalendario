...
app.whenReady().then(async () => {
  ...
  ipcMain.handle("planner:get-vacations", () => plannerStore.getVacations());
  ipcMain.handle("planner:save-vacation", (_event, vacation) => plannerStore.saveVacation(vacation));
  ipcMain.handle("planner:delete-vacation", (_event, id) => plannerStore.deleteVacation(id));
